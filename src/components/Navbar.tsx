...
export function Navbar() {
  ...
  const showBounce = isErrorPage(currentPath);
    ...
    <header className="px-4 lg:px-6 h-14 flex py-2 fixed-top z-50">
      <a href="/">
        <svg
          ...
          className={`width-14 h-14 sm:w-16 sm:h-16 animated-svg ${showAnimation ? "animated-svg-draw" : ""} ${showBounce ? "animate-bounce" : ""}`}
        >
